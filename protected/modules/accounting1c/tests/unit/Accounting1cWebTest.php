...
class Accounting1cWebTest extends CTestCase
{
	...
	public function testAccounting1cImport()
	{
		...
		$tempDir=Yii::getPathOfAlias('application.runtime.accounting1c');
		...
		@unlink($tempDir.DIRECTORY_SEPARATOR.'import.xml');
		@unlink($tempDir.DIRECTORY_SEPARATOR.'offers.xml');
		...
		ob_start();
		C1ProductsImport::processRequest('import');
