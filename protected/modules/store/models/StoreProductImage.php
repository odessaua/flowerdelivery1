...
class StoreProductImage extends BaseModel
{
	...
	public function makeMain()
	{
		...
		{
			StoreProductImage::model()->updateAll(array('is_main'=>0), 'product_id=:pid', array(':pid'=>$this->product_id));
			StoreProductImage::model()->updateByPk($this->id, array('is_main'=>1));
		}
	}
	...
	public static function countByProductAndOriginalName($product_id, $original_name)
	{
